...
<script lang="ts">
  ...
  import type { FeaturedSite } from "../models/firebase-real-db-interface";
...
<div class="featured-row" in:fade>
  <!-- 
    ~~~~~~~~~~~~~~~
  ...
  <div class="row">
    ...
    {#if viewportDesktop}
      {#if data.rating === 5}
        <img
          class="rating-img"
          src="https://www.betarena.com/widgets/betarena-ad-widget-main-main/static/star5.svg"
          alt=""
        />
      {:else if data.rating === 4}
        <img
          class="rating-img"
          src="https://www.betarena.com/widgets/betarena-ad-widget-main-main/static/star4.svg"
          alt=""
        />
      {:else if data.rating === 3}
        <img
          class="rating-img"
          src="https://www.betarena.com/widgets/betarena-ad-widget-main-main/static/star3.svg"
          alt=""
        />
      {:else if data.rating === 2}
        <img
          class="rating-img"
          src="https://www.betarena.com/widgets/betarena-ad-widget-main-main/static/star2.svg"
          alt=""
        />
      {:else}
        <img
          class="rating-img"
          src="https://www.betarena.com/widgets/betarena-ad-widget-main-main/static/star1.svg"
          alt=""
        />
      {/if}
    {/if}
      ...
      {#if showExtraInfo}
        <div class="extra-info" in:fade>
          ...
          <div class="extra-info-container">
            ...
            <a rel="external" href={data.cta_link}>
              <button
